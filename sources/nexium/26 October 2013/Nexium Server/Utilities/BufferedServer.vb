...
NotInheritable Class ServerClient(Of T)
...
#Region " Events "
    ...
    Public Delegate Sub ExceptionThrownEventHandler(sender As ServerClient(Of T), ex As Exception)
    ...
    Public Delegate Sub StateChangedEventHandler(sender As ServerClient(Of T), connected As Boolean)
    ...
    Public Delegate Sub ReadPacketEventHandler(sender As ServerClient(Of T), data As Byte())
    ...
    Public Delegate Sub ReadProgressChangedEventHandler(sender As ServerClient(Of T), progress As Double, bytesRead As Integer, bytesToRead As Integer)
    ...
    Public Delegate Sub WritePacketEventHandler(sender As ServerClient(Of T), size As Integer)
    ...
    Public Delegate Sub WriteProgressChangedEventHandler(sender As ServerClient(Of T), progress As Double, bytesWritten As Integer, bytesToWrite As Integer)
...
NotInheritable Class ServerListener(Of T)
    Implements IDisposable
...
#Region " Events "
    ...
    Public Event StateChanged As StateChangedEventHandler
    Public Delegate Sub StateChangedEventHandler(sender As ServerListener(Of T), listening As Boolean)
    ...
    Public Event ExceptionThrown As ExceptionThrownEventHandler
    Public Delegate Sub ExceptionThrownEventHandler(sender As ServerListener(Of T), ex As Exception)
    ...
    Public Delegate Sub ClientExceptionThrownEventHandler(sender As ServerListener(Of T), client As ServerClient(Of T), ex As Exception)

    Private Sub OnClientExceptionThrown(client As ServerClient(Of T), ex As Exception)
        RaiseEvent ClientExceptionThrown(Me, client, ex)
    End Sub

    Public Event ClientStateChanged As ClientStateChangedEventHandler
    Public Delegate Sub ClientStateChangedEventHandler(sender As ServerListener(Of T), client As ServerClient(Of T), connected As Boolean)

    Private Sub OnClientStateChanged(client As ServerClient(Of T), connected As Boolean)
        RaiseEvent ClientStateChanged(Me, client, connected)
    End Sub

    Public Event ClientReadPacket As ClientReadPacketEventHandler
    Public Delegate Sub ClientReadPacketEventHandler(sender As ServerListener(Of T), client As ServerClient(Of T), data As Byte())

    Private Sub OnClientReadPacket(client As ServerClient(Of T), data As Byte())
    ...
    Public Delegate Sub ClientReadProgressChangedEventHandler(sender As ServerListener(Of T), client As ServerClient(Of T), progress As Double, bytesRead As Integer, bytesToRead As Integer)

    Private Sub OnClientReadProgressChanged(client As ServerClient(Of T), progress As Double, bytesRead As Integer, bytesToRead As Integer)
    ...
    Public Delegate Sub ClientWritePacketEventHandler(sender As ServerListener(Of T), client As ServerClient(Of T), size As Integer)

    Private Sub OnClientWritePacket(client As ServerClient(Of T), size As Integer)
    ...
    Public Delegate Sub ClientWriteProgressChangedEventHandler(sender As ServerListener(Of T), client As ServerClient(Of T), progress As Double, bytesWritten As Integer, bytesToWrite As Integer)

    Private Sub OnClientWriteProgressChanged(client As ServerClient(Of T), progress As Double, bytesWritten As Integer, bytesToWrite As Integer)
...
#Region " Properties "
    ...
    Private _Clients As List(Of ServerClient(Of T))
    Public ReadOnly Property Clients() As ServerClient(Of T)()
        Get
            If _Listening Then
                Return _Clients.ToArray()
            Else
                Return New ServerClient(Of T)() {}
            End If
        End Get
    End Property
...
#End Region
    ...
    Public Sub Listen(port As UShort)
        Try
            If Not _Listening Then
                _Clients = New List(Of ServerClient(Of T))()
    ...
    Private Sub Process(s As Object, e As SocketAsyncEventArgs)
        Try
            If e.SocketError = SocketError.Success Then
                Dim T As New ServerClient(Of T)(e.AcceptSocket, _BufferSize, _MaxPacketSize)
    ...
    Private Sub HandleStateChanged(client As ServerClient(Of T), connected As Boolean)
        SyncLock _Clients
