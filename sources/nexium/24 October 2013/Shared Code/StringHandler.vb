...
Public Module StringHandler
    ...
    Public Function ValidateMessage(value As String, minLength As Integer, maxLength As Integer) As Boolean
        ...
        Return Regex.IsMatch(value, "[\t\w\x20-\x7E]+")
    End Function

    Public Function SanitizeMessage(value As String) As String
        Return Regex.Replace(value, "[^\t\w\x20-\x7E]", String.Empty)
    End Function

    Public Function ValidateMultilineMessage(value As String, minLength As Integer, maxLength As Integer) As Boolean
        If value.Length < minLength Then Return False
        If value.Length > maxLength Then Return False
    ...
    Public Function SanitizeMultilineMessage(value As String) As String
