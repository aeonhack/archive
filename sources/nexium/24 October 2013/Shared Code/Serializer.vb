...
NotInheritable Class Pack
    ...
    'NOTE: This class has been modified to serialize the PacketHeader and CommonError enums to prevent excessive casting.

    Private Shared Table As Dictionary(Of Type, Byte)
    Shared Sub New()
        ...
        Table.Add(GetType(PacketHeader), 1)
        Table.Add(GetType(ResponseCode), 1)
    End Sub

    Public Shared Function Serialize(ParamArray data As Object()) As Byte()
